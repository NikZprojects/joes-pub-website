  ...
  return (
    <div className={styles.menu}>
      <div className={styles.container}>
        ...
        <h1 class="c9" id="h.hrk91icudb51">
          <span class="c18 c2">Original Cocktails</span>
        </h1>
        <p class="c4">
          <span class="c0">
        ...
        <p class="c4">
          <span class={styles.title}>Cake by the Ocean</span>
          <span>&nbsp; Cake v</span>
          <span class="c3">Vodka, island punch schnapps, lemon-lime soda</span>
        </p>
        <p class="c4">
          <span class={styles.title}>The Izzo Special</span>
          <span>&nbsp; </span>
          <span class="c3">
        ...
        <p class="c4">
          <span class={styles.title}>Joe&rsquo;s Martini</span>
          <span>&nbsp; </span>
          <span class="c3">Gin, sweet and dry vermouth, olive brine</span>
        </p>
        <p class="c4">
          <span class={styles.title}>JP&rsquo;s Pi&ntilde;a Colada</span>
          <span>&nbsp; </span>
          <span class="c3">
        ...
        <p class="c4">
          <span class={styles.title}>Moji-jo</span>
          <span>&nbsp; </span>
          <span class="c3">White rum, simple syrup, mint, lemon-lime soda</span>
        </p>
        <p class="c4">
          <span class={styles.title}>A Peachy Cocktail</span>
          <span>&nbsp; </span>
          <span class="c3">
        ...
        <p class="c4">
          <span class={styles.title}>The Poor Man&rsquo;s Sidecar</span>
          <span>&nbsp; </span>
          <span class="c3">
        ...
        <p class="c4">
          <span class={styles.title}>Ramos Joe Fizz</span>
          <span>&nbsp; </span>
          <span class="c3">
        ...
        <p class="c4">
          <span class={styles.title}>Tequil-ing Me Softly</span>
          <span>&nbsp; </span>
          <span class="c3">
        ...
        <p class="c4">
          <span class={styles.title}>Snyzzo</span>
          <span>&nbsp; </span>
          <span class="c3">
